<!-- component -->
<div class="w-56 fixed h-full bg-gray-200 dark:bg-gray-800 xl:block lg:hidden">
    <div class="rounded-r bg-gray-900 xl:hidden flex justify-between w-full p-6 items-center">
        ...
        <div aria-label="toggler" class="flex justify-center items-center">
            ...
            <button aria-label="close" id="close" onclick="showNav(false)"
    ...
    <div id="Main"
        class="xl:rounded-r transform xl:translate-x-0 ease-in-out transition duration-500 flex flex-col justify-between h-full w-full sm:w-64 bg-gray-900">
